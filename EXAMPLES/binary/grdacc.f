...
c subtract self-energy
              ...
              u = uofgr( u )
              i = int( u ) + 1
              u = wt( 1, is ) * wt( 2, is ) * self( 2, i ) +
     +            wt( 3, is ) * wt( 4, is ) * self( 2, i + 1 )
              u = u + ( wt( 1, is ) * wt( 3, is ) +
     +                  wt( 2, is ) * wt( 4, is ) ) * self( 3, i ) +
     +                ( wt( 1, is ) * wt( 4, is ) +
     +                  wt( 2, is ) * wt( 3, is ) ) * self( 4, i )
              u = 2. * u +
     +            ( wt( 1, is )**2 + wt( 2, is )**2 ) * self( 1, i ) +
     +            ( wt( 3, is )**2 + wt( 4, is )**2 ) * self( 1, i + 1 )
              gpot( is ) = gpot( is ) - u
            end if
          end if
        end do
...
c subtract self-energy
              ...
              y = dh( 2 )
              u =
     +         ( wt( 1, is ) * wt( 3, is ) + wt( 2, is ) * wt( 4, is ) )
     +                                           / sqrt( softl2 + y**2 )
     +       + ( wt( 1, is ) * wt( 2, is ) + wt( 3, is ) * wt( 4, is ) )
     +                                           / sqrt( softl2 + x**2 )
     +       + ( wt( 2, is ) * wt( 3, is ) + wt( 1, is ) * wt( 4, is ) )
     +                                    / sqrt( softl2 + x**2 + y**2 )
              u = 2. * u + ( wt( 1, is )**2 + wt( 2, is )**2 +
     +                       wt( 3, is )**2 + wt( 4, is )**2 ) / softl
              u = u * pmass
              gpot( is ) = gpot( is ) + u
            end if
          end if
...
c subtract self-energy
                ...
                i = int( u ) + 1
                u = ( wt( 1, is ) * wt( 2, is ) +
     +                wt( 3, is ) * wt( 4, is ) ) * self( 2, i ) +
     +              ( wt( 5, is ) * wt( 6, is ) +
     +                wt( 7, is ) * wt( 8, is ) ) * self( 2, i + 1 )
                u = u +
     +              ( wt( 1, is ) * wt( 5, is ) +
     +                wt( 2, is ) * wt( 6, is ) +
     +                wt( 3, is ) * wt( 7, is ) +
     +                wt( 4, is ) * wt( 8, is ) ) * self( 3, i )
                u = u +
     +              ( wt( 1, is ) * wt( 6, is ) +
     +                wt( 2, is ) * wt( 5, is ) +
     +                wt( 3, is ) * wt( 8, is ) +
     +                wt( 4, is ) * wt( 7, is ) ) * self( 4, i )
                u = u +
     +              ( wt( 1, is ) * wt( 3, is ) +
     +                wt( 2, is ) * wt( 4, is ) ) * self( 7, i ) +
     +              ( wt( 5, is ) * wt( 7, is ) +
     +                wt( 6, is ) * wt( 8, is ) ) * self( 7, i + 1 )
                u = u +
     +              ( wt( 1, is ) * wt( 4, is ) +
     +                wt( 2, is ) * wt( 3, is ) ) * self( 8, i ) +
     +              ( wt( 5, is ) * wt( 8, is ) +
     +                wt( 6, is ) * wt( 7, is ) ) * self( 8, i + 1 )
                u = u +
     +              ( wt( 1, is ) * wt( 7, is ) +
     +                wt( 2, is ) * wt( 8, is ) +
     +                wt( 3, is ) * wt( 5, is ) +
     +                wt( 4, is ) * wt( 6, is ) ) * self( 9, i )
                u = u +
     +              ( wt( 1, is ) * wt( 8, is ) +
     +                wt( 2, is ) * wt( 7, is ) +
     +                wt( 3, is ) * wt( 6, is ) +
     +               wt( 4, is ) * wt( 5, is ) ) * self( 10, i )
                u = 2 * u +
     +            ( wt( 1, is )**2 + wt( 2, is )**2 +
     +              wt( 5, is )**2 + wt( 6, is )**2 ) * self( 1, i ) +
     +            ( wt( 3, is )**2 + wt( 4, is )**2 +
     +              wt( 7, is )**2 + wt( 8, is )**2 ) * self( 1, i + 1 )
                gpot( is ) = gpot( is ) - u
              end if
            end if
          end do
