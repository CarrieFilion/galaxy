...
C
  ...
  142    CONTINUE
         ...
         CALL RZFFTF (N,X,AZEROH,AH,BH,W)
  ...
  145       CONTINUE
            X(I) = SUM
  146    CONTINUE
         CALL RZFFTB (N,Y,AZERO,A,B,W)
         DEZB1 = 0.0
         DO 147 I=1,N
            DEZB1 = MAX(DEZB1,ABS(X(I)-Y(I)))
            X(I) = XH(I)
  147    CONTINUE
         CALL RZFFTF (N,X,AZERO,A,B,W)
         CALL RZFFTB (N,Y,AZERO,A,B,W)
         DEZFB = 0.0
         DO 148 I=1,N
...
C
  ...
  154    CONTINUE
         ...
         DCFFTB = 0.0
         DO 155 I=1,N
            DCFFTB = MAX1(DCFFTB,ABS(CX(I)-CY(I)))
            CX(I) = CY(I)
  155    CONTINUE
         CF = 1.0/FN
         CALL SZFFTF (N,CX,W)
