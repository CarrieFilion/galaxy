...
c     Corrections for F(1,1) and F(2,1).
      data P(  4)/+.647209421402969791  d-02/
      data P(  5)/-.928968790944433705  d-02/
...
c     Corrections for F(1,1), F(2,1), F(3,1-2).
      data P( 10)/+.5223046896961622    d-04/
      data P( 11)/+.17121030961750000   d-03/
      data P( 12)/-.724830016153892898  d-03/
      data P( 13)/-.7017801099209042    d-04/
