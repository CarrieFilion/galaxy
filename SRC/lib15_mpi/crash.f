...
c
c writes an error message to standard output and to the the runXXX.lis file
c   and then stops execution.  It could also close an interactive graphics
c   window gracefully, if one is open, but this option has been commented out
c
c calling arguments
...
c gracefully wrap up parallel processing
